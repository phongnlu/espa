//combine riot-route and riot-observable into 1 static lib 
//to save size as observable is embeded inside route

window.ESPA = window.ESPA || {};

window.ESPA.route = (function () {
    'use strict';
